    ...
    <div class="main-content x">
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                $sql = "SELECT * FROM account order by type ASC";


                if(isset($_GET['searchbutton'])) {
                    $search = $_GET['search'];
                    $sql = "SELECT * FROM account WHERE firstname LIKE '%$search%' OR middlename LIKE '%$search%' OR lastname LIKE '%$search%' OR type LIKE '%$search%' OR gender LIKE '%$search%' OR address LIKE '%$search%' OR birthday LIKE '%$search%' " ;
                }
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    echo"
                    <div class='showprodbox col-sm-12 col-md-12 col-lg-4 col-xl-2' style='background-color:  $backgroundColor' ;>
