...
if( $_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "SELECT * from account where username = '$usernames' and password = '$password' and type = 'admin'";
                ...
                <div class="col-sm-12 col-md-12 col-xl-6 con1">
                    <div class="containerblack">
                        ...
                        <form method="POST" class="formlogin">
                            ...
                            <p class="signup lead">If you are not an admin, login with <a href="staff-login.php">Staff Account</a> to continue. </p>
