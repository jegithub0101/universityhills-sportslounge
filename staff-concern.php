...
<head>
    ...
    <style>
        ...
        table thead th {
            background-color: #343a40; /* Semi-black color */
            color: #12171e; /* White text */
            padding: 12px;
            text-align: left;
            font-weight: 600;
            border-bottom: 2px solid #495057; /* Slightly lighter semi-black */
        }
        ...
        table tbody td {
            padding: 12px;
            border-bottom: 1px solid #dee2e6; /* Light gray for borders */
            font-size: 16px;
