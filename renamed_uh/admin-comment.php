            ...
            <div class="container-fluid">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" id="searchInput" class="form-control" placeholder="Search..." onkeypress="handleKeyPress(event)">
                            <button class="btn btn-outline-primary" type="button" onclick="searchFeedback()">Search</button>
                            <button class="btn btn-outline-primary" type="button" onclick="refreshList()"><i class="fas fa-sync-alt"></i> </button>
                        </div>
                    </div>

                <div class="col-md-6 text-end">
                    <button class="btn btn-outline-primary" type="button" onclick="showAll()">Show All</button>
                    <button class="btn btn-outline-primary" type="button" onclick="filterFeedback(5)">Outstanding</button>
                    <button class="btn btn-outline-primary" type="button" onclick="filterFeedback(4)">Very Satisfactory</button>
                    <button class="btn btn-outline-primary" type="button" onclick="filterFeedback(3)">Satisfactory</button>
                    <button class="btn btn-outline-primary" type="button" onclick="filterFeedback(2)">Unsatisfactory</button>
                    <button class="btn btn-outline-primary" type="button" onclick="filterFeedback(1)">Poor</button>
                    </div>
                </div>
