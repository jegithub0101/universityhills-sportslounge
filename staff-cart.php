        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="staff-cart.php">Cart</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row">
            <div class="whitcontainer">
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<tr id='cart_row_" . $row["cart_id"] . "'> 
                                        ...
                                        <td>" . $row["product_name"] . "<input type='hidden' id='pid' value='$row[PID]'></td>";
                            ?>
                            <td>
                ...
                <div class="placeorder">
                    ...
                    <label>
                        <select id="tablenumber" name="tablenumber" class="form-select" required>
